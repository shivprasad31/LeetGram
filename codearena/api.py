...
from challenges.api import ChallengeEventViewSet, ChallengeResultViewSet, ChallengeSubmissionViewSet, ChallengeViewSet, RunCodeView
...
from revision.api import RevisionItemViewSet, RevisionListViewSet, RevisionNoteViewSet, RevisionProblemViewSet
...
router.register("revision-notes", RevisionNoteViewSet, basename="revision-notes")
router.register("revision-problems", RevisionProblemViewSet, basename="revision-problem")
